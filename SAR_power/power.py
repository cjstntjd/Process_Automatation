...
#시리즈나 데이터 프레임을 만들면 메모리 낭비가 심함
            ...
            herz = send[' BW'][i].replace(' ','')
            s_mode = send[' Mode'][i].replace(' ','')
            ...
            if (Band =='LTE B41') or (Band == 'LTE B41(HPUE)') or (Band == 'LTE B41(IC)'):
                ...
                for j in range(st,fin+1):
                    if herz == '5MHz' and x3==12 and x4 == 6:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    elif herz == '5MHz' and x3==12 and x4==11:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-2
                    elif herz == '10MHz' and x3==1 and x4==24:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    elif herz == '10MHz' and x3==25 and x4==24:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    elif herz == '15MHz' and x3==36 and x4==18:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-2
                    elif herz == '15MHz' and x3==36 and x4==35:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-4
                    elif herz == '20MHz' and x3==50 and x4==25:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value+1
                    elif herz == '20MHz' and x3==50 and x4==49:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    else:
                        y3 = sheet['C'][j].value
                ...
                for j in range(st,fin+1):
                    if herz == '5MHz' and x3==12 and x4 == 6:
                        ...
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    elif herz == '3MHz' and x3==1 and x4==7:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    elif herz == '3MHz' and x3==8 and x4==3:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    elif herz == '3MHz' and x3==8 and x4==5:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-2
                    elif herz == '1.4MHz' and x3==1 and x4==2:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    elif herz == '1.4MHz' and x3==3 and x4==2:
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    else:
                        y3 = sheet['C'][j].value
    ...
    #결측값 보정 해주는 코드 임 다른 밴드에서 고장난 부분이 있으면 추가해서 디버깅 할것
                for j in range(st,fin+1):
                    if herz == '3MHz' and x3==1 and x4==7 :
                        y3 = sheet['C'][j].value
                        y4 = sheet['D'][j].value-1
                    elif herz == '3MHz' and x3==8 and x4==3 :
                         y3 = sheet['C'][j].value
                         ...
                         y3 = sheet['C'][j].value
                         y4 = sheet['D'][j].value-1
                    elif herz == '5MHz' and x3==12 and x4 == 6:
                         y3 = sheet['C'][j].value
                         y4 = sheet['D'][j].value-1
                    elif herz == '5MHz' and x3==12 and x4==11:
                         y3 = sheet['C'][j].value
    ...
    #결측값 보정 해주는 코드 임 다른 밴드에서 고장난 부분이 있으면 추가해서 디버깅 할것
                ...
                #시작 값을 정하고
                #이게 각 밴드마다 전부 다름 그러니까 위치를 하나하나 따는게 좋음
                if herz == '1.4MHz':    # NOT EXIST
                  st = 74

                elif herz == '3MHz':    # NOT EXIST
                  st = 74
                ...
                #결측값 보정 해주는 코드 임 다른 밴드에서 고장난 부분이 있으면 추가해서 디버깅 할것
                for j in range(st,fin+1):
                  if herz == '1.4MHz' and x3==1 and x4==7 :
                      y3 = sheet['C'][j].value
                      y4 = sheet['D'][j].value-1
                  elif herz == '1.4MHz' and x3==8 and x4==3 :
                      y3 = sheet['C'][j].value
                      y4 = sheet['D'][j].value-1
                  elif herz == '1.4MHz' and x3==8 and x4==5 :
                      y3 = sheet['C'][j].value
                      y4 = sheet['D'][j].value-2
                  elif herz == '3MHz' and x3==1 and x4==2 :
                      y3 = sheet['C'][j].value
                      y4 = sheet['D'][j].value-1
                  elif herz == '3MHz' and x3==3 and x4==2 :
                      y3 = sheet['C'][j].value
                      y4 = sheet['D'][j].value-1
                  elif herz == '5MHz' and x3==12 and x4 == 6:
                      y3 = sheet['C'][j].value
    ...
    #결측값 보정 해주는 코드 임 다른 밴드에서 고장난 부분이 있으면 추가해서 디버깅 할것
            ...
            elif Band =='LTE B66': # 주파수대역별로 계산 필요
                if (Max_power == 1) and (Hotspot_power == 0) and (back_off_power == 0):
                      if x5 == 132072 or x5==132047 or x5==132022 or x5==131997 or x5 == 131987 or x5 == 131979:
                          y5 = 'E'
                      elif x5 == 132322:
                          y5 = 'F'
                      elif x5 == 132572 or x5==132597 or x5==132622 or x5==132647 or x5==132657 or x5==132665:
                          y5 = 'G'
                      else:
                          continue
